...
#define GANG_FUNDS life_gangQG getVariable ["gang_bank",0];
...
#define LIFEHealthdisplay (GVAR_UINS ["playerHUDHealth",displayNull])
#define LIFEVehHealthdisplay (GVAR_UINS ["playerHUDVehHealth",displayNull])
#define LIFEctrl(ctrl) ((uiNamespace getVariable ["playerHUD",displayNull]) displayCtrl ctrl)
#define LIFEHealthctrl(ctrl) ((GVAR_UINS ["playerHUDHealth",displayNull]) displayCtrl ctrl)
#define LIFEVehHealthctrl(ctrl) ((GVAR_UINS ["playerHUDVehHealth",displayNull]) displayCtrl ctrl)
//SpyGlass Macros
#define SPYGLASS_END \
