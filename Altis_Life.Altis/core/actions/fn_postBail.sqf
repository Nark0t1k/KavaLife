...
if(life_KavaBank < life_bail_amount) exitWith {[format[localize "STR_NOTF_Bail_NotEnough",life_bail_amount]] call life_fnc_showNotification;};

SUB(life_KavaBank,life_bail_amount);
life_bail_paid = true;
