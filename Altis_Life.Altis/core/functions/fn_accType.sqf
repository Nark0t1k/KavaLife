...
/*
    ...
    *Functionality from Virtual Ammobox System*
    ...
    Robalo gave me some code that showed me the way. If it isn't 100% compatible then IDFK. The count in a count drove me nuts and
...
_weaponArray = [primaryWeapon player, secondaryWeapon player, handgunWeapon player];
{
    ...
    if (!(_x isEqualTo "")) then
    {
        ...
        if (count _newItems > 0) then {
            //This gets weird with count in count :\
            {
