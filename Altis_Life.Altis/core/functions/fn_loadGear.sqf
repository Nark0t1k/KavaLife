...
if((playerside isEqualTo independent) && ((count weapons player) > 0))exitWith 
{
	[] call life_fnc_medicLoadout;
};
...
{_handle = [_x,true,false,false,false] spawn life_fnc_handleItem; waitUntil {scriptDone _handle};true;} count _items;
