...

{
	if(ITEM_VALUE(configName _x) > 0) then {
		playerInventoryArray pushBack [(configName _x),ITEM_VALUE(configName _x),3,"ymenu"];
	};
...
_price = 0;
{if(_x select 5 isEqualTo _uid && _x select 1 isEqualTo 0) then {playerInventoryArray pushBack [_x select 3 select 0,_x select 2,_x select 7,"ymenu",_x select 8,_x select 4,_x select 0]};true;} count all_ah_items; //GET Y MENU AND THEIR STATUS
{if(_x select 5 isEqualTo _uid && _x select 1 isEqualTo 1) then {playerInventoryArray pushBack [_x select 3 select 0,_x select 2,_x select 7,"imenu",_x select 8,_x select 4,_x select 0]};true;} count all_ah_items; //GET I MENU AND THEIR STATUS
...
((findDisplay 15600) displayCtrl 15660) ctrlSetText "textures\Ekav.jpg";
