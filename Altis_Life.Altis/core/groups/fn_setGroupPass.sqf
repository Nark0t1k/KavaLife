...
if(leader(group player) != player) exitWith {hint "Tu ne peux pas faire cela."};
...
["<t align='center'>Entrer le mot de passe.</t>", "Choisir Pass Groupe", "Choisir Pass"] call life_fnc_inputMenu;
if(life_input_response isEqualTo "") exitWith {[false] spawn life_fnc_groupManagement};
