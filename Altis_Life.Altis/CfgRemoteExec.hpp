...
class CfgRemoteExec {
    class Functions {
		...
		F(life_fnc_vehicleHVMenu,CLIENT)
		F(life_fnc_amendeReceive,CLIENT)
		F(life_fnc_showMessage,CLIENT)
		F(life_fnc_flashEffect,CLIENT)
		...
		F(TON_fnc_getFullMessages,SERVER)
		...
		F(TON_fnc_restoreVehicle,SERVER)
		F(TON_fnc_vehicleSellHV,SERVER)
		F(TON_fnc_getHVVehicles,SERVER)
		F(TON_fnc_buyVehicleHV,SERVER)
		F(TON_fnc_moneyFunction,SERVER)
